...
extern void *mono_aot_module_BackgroundWorkDemo_info;
...
{
	mono_aot_register_module (mono_aot_module_BackgroundWorkDemo_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "BackgroundWorkDemo.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
